...
import sys
# sys.path.append('/raid/sjx/mmdetection/mmdet/models')
from ..builder import NECKS
# sys.path.append('/raid/sjx/mmdetection/mmdet/models/backbones')
...
class RepDilatedEncoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, block_mid_channels,
                 num_residual_blocks, deploy=False):
        super(RepDilatedEncoder, self).__init__()
    ...
    def _init_layers(self):
        ...
        self.lateral_conv_bn = RepVGGConvModule(
    ...
    def forward(self, feature):
        out = self.lateral_conv_bn(feature[-1])
